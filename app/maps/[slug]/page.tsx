import { getMapBySlug, getAllMaps } from '@/lib/maps';
    ...
    return (
        <article className="max-w-3xl mx-auto py-12 px-4 md:px-0">
            ...
            <div className="flex justify-between font-serif text-lg font-medium text-amber-900/80">
                <Link href="/maps" className="hover:text-amber-950 hover:underline decoration-1 underline-offset-4">
                    ← Back to Maps
                </Link>
            </div>
        </article>
